...
const SurveyCreate = () => {
  ...
  const { createSurvey, loading } = useSurveys();
  ...
  const handleSubmit = async (e, saveStatus = 'draft') => {
    e.preventDefault();
    ...
    try {
      ...
      if (newSurvey) {
        // Navigate to builder to add questions
        navigate(`/surveys/${newSurvey.survey_id}/builder`);
      }
    } catch (error) {
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Set up a new survey with basic information
            </p>
          </div>
        </div>
      </div>
